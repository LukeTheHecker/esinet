...
model_params_dict = {
    ...
    "LSTM Medium": dict(n_lstm_layers=2, n_lstm_units=85, n_dense_layers=0, scale_individually=False),
    "LSTM Medium": dict(n_lstm_layers=2, n_lstm_units=85, n_dense_layers=0, scale_individually=True),
...
for model_name, model_params in model_params_dict.items():
    ...
    net.save(r'models', name=f'{model_name}_1-1000points_standard-cosine-mse_scalingtest')
    del net
